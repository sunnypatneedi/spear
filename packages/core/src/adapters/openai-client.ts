...
/**
 * Global SPEAR runtime instance (singleton)
 */
let globalRuntime: SPEARRuntime | null = null;

/**
 * Initialize global SPEAR runtime
 * 
 * Call this once at application startup to configure SPEAR.
 * 
...
/**
 * Get global SPEAR runtime (initializes with defaults if not already initialized)
 */
 ...
 * 
 * Wraps any LLM function with SPEAR input/output gates.
 * 
