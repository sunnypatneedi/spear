# SAPPS AGENTS.md - AI Agent Instructions

**Parent Guide**: See `/AGENTS.md` for general SayMake conventions.

This file provides AI-specific guidance for contributing to SAPPS (Secure AI Prompt Protection System).
